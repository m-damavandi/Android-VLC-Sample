...
public abstract class Dialog {
    ...
    public static class LoginDialog extends IdDialog {
        ...
        public LoginDialog(long id, String title, String text, String defaultUsername, boolean askStore) {
        ...
        private static native void nativePostLogin(long id, String username, String password, boolean store);

        private static void myPostLogin(long id, String username, String password, boolean store){
